...
const historyList = [
    {   
        content: 'Tình bạn diệu kỳ',
    },
    {
        content: 'Chắc ai đó sẽ về',
    },
    {
        content: 'Em của ngày hôm qua',
    },
    {
        content: 'Chúng ta của hiện tại',
    },
]
  ...
  return (
    <div className="header" ref={headerRef}>
        <div className="header_search">
            <i className="bi bi-arrow-left header_arrow_icon hide-on-mobile"></i>
            <i className="bi bi-arrow-right header_arrow_icon disabled-btn hide-on-mobile"></i>
            <div className="header_search_wrapper">
                <i className="bi bi-search header_search_icon"></i>
                <input 
                ...
                />
                <div className={`header_search_history ${focus ? 'display-element' : ''}`}>
                    <ul className="header_history_list">
                        {
                            historyList.map((historyItem, index) => (
                                <li key={index} className="header_history_item">
                                    <i className="bi bi-search header_history_icon"></i>
                                    <span className="header_history_text">{historyItem.content}</span>
                                </li>
                            ))
                        }
                    </ul>
        ...
        <ul className={`header_options${focus ? ' hide-on-mobile' : ''}`}>
            <li className="header_option">
                <svg width="20" height="20" className="header_option_icon" viewBox="0 0 20 20">
                    <defs>
                    ...
                    <g fill="none" fillRule="evenodd" transhtmlform="translate(2 3)">
            ...
            <li className="header_option hide-on-mobile">
                <input type="file" id="header_option_upfile" />
                <label htmlFor="header_option_upfile">
                    <i className="bi bi-upload header_option_icon"></i>
                </label>
            </li>
            <li className="header_option hide-on-mobile">
                <i className="bi bi-gear header_option_icon"></i>
            </li>
            <li className="header_option">
                <img src="./images/image-slide/amee.jpg" alt="" className="header_user_image" />
            </li>    
        </ul>
    </div>
  );
